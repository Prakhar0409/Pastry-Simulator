...
public class Simulator2 {
		...
		public void simulate() throws Exception{
			...
			int num_bytes;
			File file = new File("hops_pdf.txt");
	        if (!file.exists()) {
	             file.createNewFile();
	        }
				...
				if(System.in.available()>0){
					...
					if (num_bytes < 0){
						...
						if (line != null && line.length() > 0 && line.charAt(line.length()-1)=='\n') {
							...
							System.out.println("Simulator2: User entered: "+line);
							if("end".equals(line)){
					    		System.out.println("Simulator2: Ending Simulations");
					    		bw.close();
					    		System.exit(0);
					    	}
							line = null;
